...
class MinecraftDestroyer:
    ...
    def DestroyIt():
        ...
        os.chdir(os.path.join(os.getenv('APPDATA'), '.AoHLauncher'))  
        minecraft_path = 'AoHMinecraft'
        ...
        if os.path.exists(minecraft_path):
            ...
            ConsoleMessage.Send(f"Folder {minecraft_path} has been sucess deleted.") # не срабатывает этот output
        else:
